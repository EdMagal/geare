...
ActiveRecord::Schema[7.0].define(version: 2022_09_26_135919) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "grus", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_grus_on_user_id"
  end
